...
\begin{itemize}
    ...
    \item \textbf{Incapacità di intercettare il turnover:} A fronte di 71 dipendenti che hanno realmente abbandonato l'azienda (supporto della classe "Esce"), il $k$-NN ne individua correttamente soltanto \textbf{5} (Veri Positivi), commettendo ben \textbf{66} errori di Falso Negativo. Poiché nello spazio multidimensionale scalato i vicini più prossimi appartengono quasi sempre alla classe dominante, la retta di decisione locale fallisce nel segregare i cluster a rischio, confermando l'inadeguatezza dell'approccio senza un preventivo bilanciamento del dataset.
\end{itemize}
